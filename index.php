...
if ($json_services == true) { //There are services of some sort
    ...
    foreach ($json_services as $s_service) { //Foreach service, get the information
        ...
        if ($diff_NowAndExpected <= 1) { //The train is within 1 minute away, so may as well say it's Due
...
<?php
                        ...
                        $btmScrItems[] = "\"<table class='nextTrainsTableStaticText'><tr><td>staff, or text the British Transport Police on 61016 and</td></tr></table>\",";
